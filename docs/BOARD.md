...
| T17 | MCP под doc@1: `includeHidden` в чтении (скрытые узлы по умолчанию не отдаются), типы `hidden`/`text.runs`, приём doc@0 и doc@1 | `src/mcp/**` | claude | 2026-09-23T05:44Z | wip |
