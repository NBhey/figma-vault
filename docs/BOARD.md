...
| T25 | Официальный MCP Registry: `mcpName`, `server.json`, тест согласованности версий, подготовка 0.1.3 без публикации | корень, `server.json`, `src/cli/registry.test.ts` | claude | 2026-09-23T18:21Z | wip |
