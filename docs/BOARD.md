...
| T18 | Релиз 0.1.1: версия, README под doc@1, версия MCP-сервера из package.json, проверка tarball | корень, `README*.md`, `src/mcp/server.ts` | claude | 2026-09-23T05:58Z | blocked |
| T20 | CLI сверки: `figma-vault verify` + `--snippet` для снимка DOM, шаг в `/figma` | `src/cli/**` | claude | 2026-09-23T06:10Z | wip |
