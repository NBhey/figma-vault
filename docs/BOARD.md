...
| T27 | Сигналы для Glama: `glama.json`, CI на GitHub Actions (тесты, типы, сборка, дымовой прогон CLI), значок CI в README | корень, `.github/**`, `README*.md` | claude | 2026-09-23T18:42Z | wip |
